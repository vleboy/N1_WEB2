...
export default {
  ...
  methods: {
    ...
    getPlayerAccount () {
      ...
      let st = util.timeZoneConversion(this.amountDate[0].getTime(),this.$store.state.timeZone)
      let et = util.timeZoneConversion(this.amountDate[1].getTime(),this.$store.state.timeZone)
