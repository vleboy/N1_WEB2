...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      //按序请求渲染echarts
      // 先请求2个
      httpRequest("get", "/visual/pie/game", this.paramsInit(), "map").then(res => {
      ...
      httpRequest("get", "/visual/line/day", this.paramsInit(), "map").then(res => {
        ...
        // 再请求2个
        httpRequest("get", "/visual/map/china", this.paramsInit(), "map").then(res => {
        ...
        httpRequest("get", "/visual/line/player", this.paramsInit(), "map").then(res => {
          ...
          // 最后请求1个
          httpRequest("get", "/visual/map/world", this.paramsInit(), "map").then(res => {
    ...
    distributionInit() {
      this.spinShow = true;
      httpRequest("get", "/visual/graph/hours", this.paramsInit(), "map").then(res => {
        this.houreMomentData = res.data;
        this.spinShow = false;
        this.houreMomentBarConfigure();
      });
      httpRequest("get", "/visual/graph/weeks", this.paramsInit(), "map").then(res => {
